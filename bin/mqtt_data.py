...
#
#   NAME  Name des Messwerts - zugleich das MQTT-Thema (hinter dem eingestellten
...
#   ONLY_WITH_PRODUCT  Nur noch ein Vermerk fuer die Anzeige ("nur mit ComfoCool
#         sinnvoll"). Frueher wurde damit die Registrierung unterdrueckt, wenn
#         das Zubehoer fehlt - das ist entfallen: Die Anlage nimmt diese
#         Abonnements auch ohne Modul an und antwortet mit 0. Wen der
#         nichtssagende Wert stoert, waehlt den Sensor in den Einstellungen ab.
#
# Ein zusaetzlicher Messwert braucht einen Eintrag HIER - ueber die
# Weboberflaeche laesst sich nur an- und abwaehlen, nichts ergaenzen. Grund:
# Der Rohwert wird nach Byte-Laenge dekodiert, nicht nach PDO-Typ (siehe
# _handle_rpdo_notification in comfoconnect.py). Vierbyte-Werte kaemen als
# Hex-Zeichenkette an - deshalb fehlen hier bewusst die pdids 230, 338, 342
# und 343, die die Referenzbibliothek zwar kennt, die wir aber nicht sinnvoll
# uebertragen koennten.
#
